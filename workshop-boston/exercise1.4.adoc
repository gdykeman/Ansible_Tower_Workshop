...
|===
image::at_cred_detail.png[Cred_Detail, 600,600,caption="Figure 5: ",title="Adding a Credential", link="https://s3.amazonaws.com/ansible-workshop-bos.redhatgov.io/_images/at_cred_detail.png"]
